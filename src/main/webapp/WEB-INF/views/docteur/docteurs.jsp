...
<s:url value="/admin/docteur/delete" var="delete" />
<s:url value="/admin/docteur/add" var="add" />
<s:url value="/admin/docteur/edit" var="edit" />
<section class="content">
    <div class="row">
        <div class="col-xs-12 margin-bottom">
            <div class="callout callout-success" style="margin-bottom: 0!important;">
                <h4><i class="fa fa-info"></i> Note:</h4>
            This is your <b> Doctor </b> account page. You can now make updates!
            </div>
        </div>
        <div class="col-xs-12">
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <c:choose>
                                            <c:when test='${docteur.username==null}'>
                                                <input type="text" class="form-control" name="username"
                                                       required="required"  value="${docteur.username}"/>
                                            </c:when>
                                            <c:when test='${docteur.username!=null}'>
                                                <input type="text" class="form-control" name="username"
                                                       required="required"  value="${docteur.username}" disabled/>
                                            </c:when>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control" name="password"
                                               required="required" value="${docteur.password}"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="nom"
                                               required="required"  value="${docteur.nom}" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="prenom"
                                               required="required" value="${docteur.prenom}"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="adresse"
                                               required="required" value="${docteur.adresse}" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="tel"
                                               required="required"  value="${docteur.tel}"/>
                                    </div>
                                </div>
                                ...
                                <table id="example2"
                                    ...
                                    <tbody>
                                        <c:forEach var="docteur" items="${docteurs}">
                                            <tr>
                                                <td>${docteur.username}</td>
                                                <td>${docteur.nom}</td>
                                                <td>${docteur.prenom}</td>
                                                <td>${docteur.adresse}</td>
                                                <td>${docteur.tel}</td>
                                                <td colspan="2"><a href="${edit}/${docteur.username}"
                                                                   type="button" class="btn btn-default "> <span
                                                            class="glyphicon glyphicon-edit"></span> Edit
                                                    </a> <a href="${delete}/${docteur.username}" type="button"
